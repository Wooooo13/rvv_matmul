...
parser = argparse.ArgumentParser(
    description="A simple RISC-V system with NO caches (direct memory access)."
)
parser.add_argument(
    "-c",
    "--cmd",
...
print(f"[config] RISC-V Simple CPU (NO CACHE)")
print(f"[config] CPU: RiscvTimingSimpleCPU, 1 core")
